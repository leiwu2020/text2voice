...
def test_audio_streaming():
    ...
    print("🎵 Testing Audio Streaming Functionality")
    print("=" * 50)
    ...
    test_text = "Hello, this is a test of the audio streaming functionality."
            ...
            if result.get('success'):
                ...
                if play_url:
                    ...
                    if stream_response.status_code == 200:
                        print("✅ Audio streaming endpoint working")
    ...
    print("\n📱 To test Windows browser behavior:")
